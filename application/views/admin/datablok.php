                    ...
                    <div class="card-body">
                      <div class="form-row">
                        <div class="form-group col-md-6">
                          <label for="namaitem">Nama blok</label>
                          <input type="text" class="form-control" name="nama_blok" placeholder="Nama blok">
...
<?php $this->load->view('admin/_partials/footer');?>
  ...
  <script> 
    ...
    var target = 2; 
    var searching = true;
    var actionUrlGet = "datablok/ajax_list";
    var actionUrlAdd = "datablok/ajax_add";
    var actionUrlEdit = "datablok/ajax_edit/";
    var actionUrlupdate = "datablok/ajax_update";
    var actionUrlDelete = "datablok/ajax_delete/";
    ...
    function edit(id)
    {
        ...
        $.ajax({
            ...
            {
              $('[name="id"]').val(data.id);
              $('[name="nama_blok"]').val(data.nama_blok);
